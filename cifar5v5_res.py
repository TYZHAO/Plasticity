...
model_root = '/scratch/tz1303/ckpts_5v5_nonplas'
    ...
    #-------------------------------------------------------------------------------------%
        ...
        while True:
            try:
                ...
                ops = [train_op, loss, epoch, acc, lr]
                _, lossvalue, epoch_num, accuracy, learning_rate = sess.run(ops, feed_dict = {handle: train_handle})
