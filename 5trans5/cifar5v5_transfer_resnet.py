...
def inference():
    ...
    model_root = '/scratch/tz1303/ckpts_5v5_transfer_on_2'
    ...
    print(model_dir)
    model_name = model_dir+'/trans_res'+str(6*num_res_blocks+2)
    
    global_step=tf.get_variable('global_step',(), trainable=False, initializer=tf.zeros_initializer)
    
    epoch = tf.ceil(global_step*BATCH_SIZE/use_train)
    ...
    pretrained_model = '/scratch/tz1303/ckpts_5v5_train_on_1/1534269982/pre_res20-9500'
